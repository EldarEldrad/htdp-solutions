...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Exercise_197) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t write repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect (most-frequent.v2 AS-LIST) (most-frequent.v1 AS-LIST))
