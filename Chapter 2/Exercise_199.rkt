...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Exercise_199) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t write repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp")) #f)))
...
(define ltrack-example-1 '())
(define ltrack-example-2 (list track-example-1))
(define ltrack-example-3 (list track-example-1 track-example-2))
