...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise_344) (read-case-sensitive #t) (teachpacks ((lib "abstraction.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp"))) (htdp-settings #(#t quasiquote repeating-decimal #f #t none #f ((lib "abstraction.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp")) #f)))
...
(define (find-all dr str)
  (filter (lambda (x) (string=? str (first (reverse x))))
          (ls-R dr)))