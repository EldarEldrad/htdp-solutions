...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise_56) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect (stop? YDELTA) #false)
(check-expect (stop? "resting") #false)
(check-expect (stop? -1) #false)
(check-expect (stop? (/ YDELTA 2)) #true)
(define (stop? x)
  (cond
    [(and (number? x) (<= 0 x) (< x YDELTA)) #true]
    [else #false]))
