...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise_075) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect (ufo-move-1 u3)
              (make-ufo (make-posn 38 74) v1))
(check-expect (ufo-move-1 u4)
              (make-ufo (make-posn 25 74) v2))
(define (ufo-move-1 u)
