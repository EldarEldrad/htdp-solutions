...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise_086) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect (too-wide-text? (make-editor "hello" "world") " ") #false)
(check-expect (too-wide-text? (make-editor "" "hello world") " ") #false)
(check-expect (too-wide-text? (make-editor "hello world" "") " ") #false)
(check-expect (too-wide-text? (make-editor "hellosadfjskdfjkfjksdfjdskfjdskfdfdfkj" "worlddsfasfsfdsfdfdfdf")
                              " ")
              #true)
(check-expect (too-wide-text? (make-editor "hellosadfjskdfjkfjksdfjdskfjdskfdfdfkjworlddsfasfsfdsfdfdfdf" "")
                              " ")
              #true)
(check-expect (too-wide-text? (make-editor "" "hellosadfjskdfjkfjksdfjdskfjdskfdfdfkjworlddsfasfsfdsfdfdfdf")
                              " ")
...
(define (too-wide-text? ed ke)
  (>= (image-width (text (string-append ke (editor-pre ed) (editor-post ed))
                         TEXT-SIZE "black"))
      WIDTH))
