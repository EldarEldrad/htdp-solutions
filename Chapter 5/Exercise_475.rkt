...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise_475) (read-case-sensitive #t) (teachpacks ((lib "abstraction.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t quasiquote repeating-decimal #f #t none #f ((lib "abstraction.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
    ...
    [else (local ((define next (neighbors origination G))
                  ...
                  (define (find-path/list lo-Os D G)
                    (foldr (lambda (x rst)
                             (if (cons? x) x rst))
                           #false
                           (map (lambda (o) (find-path o D G)) lo-Os)))
                  (define candidate
