...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise_287) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t quasiquote repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(define (eliminate-expensive ua loir)
  (filter (lambda (ir) (< (IR-sales-price ir) ua)) loir))
...
(define (selection los1 los2)
  (filter (lambda (str) (member? str los2)) los1))