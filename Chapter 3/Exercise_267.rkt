...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Exercise_267) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t quasiquote repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
(define rate 1.06)
...
(define (convert-euro lous)
  (local ((define (us-to-eu us) (/ us rate)))
    (map us-to-eu lous)))
...
(check-expect (convertFC '(104 -4 32 14 23))
              '(40 -20 0 -10 -5))
(define (convertFC fs)
  (local ((define (f-to-c f) (* (- f 32) (/ 5 9))))
    (map f-to-c fs)))
